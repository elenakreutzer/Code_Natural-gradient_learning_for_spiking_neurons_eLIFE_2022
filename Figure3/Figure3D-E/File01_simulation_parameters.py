...
parameter={
    ...
    #learningrates
    "learningrate_natural":0.00025,              #learning rate for natural-gradient-descent algorithm (Eqn. 13)
    "learningrate_euclidean":0.0000007,        #learning rate for Euclidean-gradient-descent algorithm (Eqn. 10)
    ...
    #lookup table
    "lt_file":"2019-01-06_lt_newtf1.5.npy",#file that contains pre-calculated look-up table for the coefficients g_1,..,g_4
    ...
    "initial2":0.5,                             #second component of initial weight vector, will be multiplied by 1./N
